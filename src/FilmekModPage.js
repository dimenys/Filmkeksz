    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                console.log(res)
                setFilm(filmData);
                setModnev(filmData.nev);
                setModkiadasEve(filmData.kiadasEve);
                setModertekeles(filmData.ertekeles);
                setModkepneve(filmData.kepneve);
            } catch (error) {
                console.log(error);   
            } 
        })();
        ...
        <div className='p-5 content bg-lavender text-center'>
            ...
            >
                <div className='form-group row pb-3'>
                    <label htmlFor="nev" className='col-sm-3 col-form-label'> Cím: </label>
                    <div>
